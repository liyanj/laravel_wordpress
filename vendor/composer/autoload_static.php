...
class ComposerStaticInit7b20e4d61e2f88170fbbc44c70d38a1f
{
    ...
    public static $classMap = array (
        'AuthenticationTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/AuthenticationTest.php',
        'Category' => __DIR__ . '/..' . '/jgrossi/corcel/models/Category.php',
        'Comment' => __DIR__ . '/..' . '/jgrossi/corcel/models/Comment.php',
        'CommentTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/CommentTest.php',
        ...
        'HasMetaTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/HasMetaTest.php',
        'Menu' => __DIR__ . '/..' . '/jgrossi/corcel/models/Menu.php',
        'MenuTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/MenuTest.php',
        'Options' => __DIR__ . '/..' . '/jgrossi/corcel/models/Options.php',
        'OptionsTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/OptionsTest.php',
        ...
        'PostMetaTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/PostMetaTest.php',
        'PostTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/PostTest.php',
        'PostTypeTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/PostTypeTest.php',
        ...
        'TaxonomyTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/TaxonomyTest.php',
        'Text_Template' => __DIR__ . '/..' . '/phpunit/php-text-template/src/Template.php',
        'User' => __DIR__ . '/..' . '/jgrossi/corcel/models/User.php',
        'UserTest' => __DIR__ . '/..' . '/jgrossi/corcel/tests/UserTest.php',
        'Video' => __DIR__ . '/..' . '/jgrossi/corcel/tests/PostTypeTest.php',
    );
